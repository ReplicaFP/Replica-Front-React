        ...
        <div class="footer-basic bg-primary">
            <footer>
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item text-light"><Link to="/employee_internships">Prácticas Tuteladas</Link></li>
                    <li class="list-inline-item text-light"><Link to="/employee_profile"> Mi perfil de Empleado</Link></li>
